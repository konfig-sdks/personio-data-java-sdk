...
public class EmployeesUpdateEmployeeFieldsRequest1 {
 ...
 public enum EmployeeStatusEnum {
  ...
  public EmployeesUpdateEmployeeFieldsRequest1() {
  }

  public EmployeesUpdateEmployeeFieldsRequest1 employeeFirstName(String employeeFirstName) {
  ...
  **/
  ...
  public EmployeesUpdateEmployeeFieldsRequest1 employeeLastName(String employeeLastName) {
  ...
  **/
  ...
  public EmployeesUpdateEmployeeFieldsRequest1 employeePreferredName(String employeePreferredName) {
  ...
  **/
  ...
  public EmployeesUpdateEmployeeFieldsRequest1 employeeGender(EmployeeGenderEnum employeeGender) {
  ...
  **/
  ...
  public EmployeesUpdateEmployeeFieldsRequest1 employeePosition(String employeePosition) {
  ...
  **/
  ...
  public EmployeesUpdateEmployeeFieldsRequest1 employeeDepartment(String employeeDepartment) {
  ...
  **/
  ...
  public EmployeesUpdateEmployeeFieldsRequest1 employeeHireDate(LocalDate employeeHireDate) {
  ...
  **/
  ...
  public EmployeesUpdateEmployeeFieldsRequest1 employeeWeeklyWorkingHours(Double employeeWeeklyWorkingHours) {
  ...
  public EmployeesUpdateEmployeeFieldsRequest1 employeeWeeklyWorkingHours(Integer employeeWeeklyWorkingHours) {
  ...
  **/
  ...
  public EmployeesUpdateEmployeeFieldsRequest1 employeeSupervisorId(Double employeeSupervisorId) {
  ...
  public EmployeesUpdateEmployeeFieldsRequest1 employeeSupervisorId(Integer employeeSupervisorId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Employee ID of the Supervisor to be assigned. It needs to belong to a current existing employee and not the same as the one of the employee being updated, otherwise an error will be returned. If sent as null, will unset the employee's supervisor.")
  ...
  public EmployeesUpdateEmployeeFieldsRequest1 employeeStatus(EmployeeStatusEnum employeeStatus) {
  ...
  **/
   ...
   * @return the EmployeesUpdateEmployeeFieldsRequest1 instance itself
   */
  public EmployeesUpdateEmployeeFieldsRequest1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeesUpdateEmployeeFieldsRequest1 employeesUpdateEmployeeFieldsRequest1 = (EmployeesUpdateEmployeeFieldsRequest1) o;
    return Objects.equals(this.employeeFirstName, employeesUpdateEmployeeFieldsRequest1.employeeFirstName) &&
        Objects.equals(this.employeeLastName, employeesUpdateEmployeeFieldsRequest1.employeeLastName) &&
        Objects.equals(this.employeePreferredName, employeesUpdateEmployeeFieldsRequest1.employeePreferredName) &&
        Objects.equals(this.employeeGender, employeesUpdateEmployeeFieldsRequest1.employeeGender) &&
        Objects.equals(this.employeePosition, employeesUpdateEmployeeFieldsRequest1.employeePosition) &&
        Objects.equals(this.employeeDepartment, employeesUpdateEmployeeFieldsRequest1.employeeDepartment) &&
        Objects.equals(this.employeeHireDate, employeesUpdateEmployeeFieldsRequest1.employeeHireDate) &&
        Objects.equals(this.employeeWeeklyWorkingHours, employeesUpdateEmployeeFieldsRequest1.employeeWeeklyWorkingHours) &&
        Objects.equals(this.employeeSupervisorId, employeesUpdateEmployeeFieldsRequest1.employeeSupervisorId) &&
        Objects.equals(this.employeeStatus, employeesUpdateEmployeeFieldsRequest1.employeeStatus)&&
        Objects.equals(this.additionalProperties, employeesUpdateEmployeeFieldsRequest1.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(employeeFirstName, employeeLastName, employeePreferredName, employeeGender, employeePosition, employeeDepartment, employeeHireDate, employeeWeeklyWorkingHours, employeeSupervisorId, employeeStatus, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmployeesUpdateEmployeeFieldsRequest1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeesUpdateEmployeeFieldsRequest1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeesUpdateEmployeeFieldsRequest1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeesUpdateEmployeeFieldsRequest1 is not found in the empty JSON string", EmployeesUpdateEmployeeFieldsRequest1.openapiRequiredFields.toString()));
        }
      }
      if ((jsonObj.get("employee[first_name]") != null && !jsonObj.get("employee[first_name]").isJsonNull()) && !jsonObj.get("employee[first_name]").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("employee[last_name]") != null && !jsonObj.get("employee[last_name]").isJsonNull()) && !jsonObj.get("employee[last_name]").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeesUpdateEmployeeFieldsRequest1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeesUpdateEmployeeFieldsRequest1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeesUpdateEmployeeFieldsRequest1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeesUpdateEmployeeFieldsRequest1.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeesUpdateEmployeeFieldsRequest1>() {
           @Override
           public void write(JsonWriter out, EmployeesUpdateEmployeeFieldsRequest1 value) throws IOException {
           ...
           @Override
           public EmployeesUpdateEmployeeFieldsRequest1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeesUpdateEmployeeFieldsRequest1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeesUpdateEmployeeFieldsRequest1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeesUpdateEmployeeFieldsRequest1
  * @throws IOException if the JSON string is invalid with respect to EmployeesUpdateEmployeeFieldsRequest1
  */
  public static EmployeesUpdateEmployeeFieldsRequest1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeesUpdateEmployeeFieldsRequest1.class);
  }

 /**
  * Convert an instance of EmployeesUpdateEmployeeFieldsRequest1 to an JSON string
  *
  * @return JSON string
  */
