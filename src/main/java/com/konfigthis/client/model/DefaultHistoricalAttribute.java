...
public class DefaultHistoricalAttribute {
 ...
 public enum DataTypeEnum {
  ...
  public DefaultHistoricalAttribute() {
  }

  public DefaultHistoricalAttribute attributeId(String attributeId) {
  ...
  **/
  ...
  public DefaultHistoricalAttribute dataType(DataTypeEnum dataType) {
  ...
  **/
  ...
  public DefaultHistoricalAttribute value(String value) {
  ...
  **/
  ...
  public DefaultHistoricalAttribute employeeId(Integer employeeId) {
  ...
  **/
  ...
  public DefaultHistoricalAttribute effectiveDate(String effectiveDate) {
  ...
  **/
  ...
  public DefaultHistoricalAttribute entityId(String entityId) {
  ...
  **/
  ...
  public DefaultHistoricalAttribute duration(Integer duration) {
  ...
  **/
  ...
  public DefaultHistoricalAttribute costCenters(List<CostCenter> costCenters) {
  ...
  public DefaultHistoricalAttribute addCostCentersItem(CostCenter costCentersItem) {
  ...
  **/
  ...
  public DefaultHistoricalAttribute amount(String amount) {
  ...
  **/
  ...
  public DefaultHistoricalAttribute currencySymbol(String currencySymbol) {
  ...
  **/
   ...
   * @return the DefaultHistoricalAttribute instance itself
   */
  public DefaultHistoricalAttribute putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DefaultHistoricalAttribute defaultHistoricalAttribute = (DefaultHistoricalAttribute) o;
    return Objects.equals(this.attributeId, defaultHistoricalAttribute.attributeId) &&
        Objects.equals(this.dataType, defaultHistoricalAttribute.dataType) &&
        Objects.equals(this.value, defaultHistoricalAttribute.value) &&
        Objects.equals(this.employeeId, defaultHistoricalAttribute.employeeId) &&
        Objects.equals(this.effectiveDate, defaultHistoricalAttribute.effectiveDate) &&
        Objects.equals(this.entityId, defaultHistoricalAttribute.entityId) &&
        Objects.equals(this.duration, defaultHistoricalAttribute.duration) &&
        Objects.equals(this.costCenters, defaultHistoricalAttribute.costCenters) &&
        Objects.equals(this.amount, defaultHistoricalAttribute.amount) &&
        Objects.equals(this.currencySymbol, defaultHistoricalAttribute.currencySymbol)&&
        Objects.equals(this.additionalProperties, defaultHistoricalAttribute.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DefaultHistoricalAttribute {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DefaultHistoricalAttribute
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DefaultHistoricalAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DefaultHistoricalAttribute is not found in the empty JSON string", DefaultHistoricalAttribute.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DefaultHistoricalAttribute.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DefaultHistoricalAttribute' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DefaultHistoricalAttribute> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DefaultHistoricalAttribute.class));

       return (TypeAdapter<T>) new TypeAdapter<DefaultHistoricalAttribute>() {
           @Override
           public void write(JsonWriter out, DefaultHistoricalAttribute value) throws IOException {
           ...
           @Override
           public DefaultHistoricalAttribute read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DefaultHistoricalAttribute instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DefaultHistoricalAttribute given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DefaultHistoricalAttribute
  * @throws IOException if the JSON string is invalid with respect to DefaultHistoricalAttribute
  */
  public static DefaultHistoricalAttribute fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DefaultHistoricalAttribute.class);
  }

 /**
  * Convert an instance of DefaultHistoricalAttribute to an JSON string
  *
  * @return JSON string
  */
