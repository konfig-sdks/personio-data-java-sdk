...
import com.konfigthis.client.model.WorkScheduleValue;
...
public class WorkSchedule {
  ...
  private WorkScheduleValue value;
  ...
  public WorkSchedule label(Object label) {
  ...
  **/
  ...
  public WorkSchedule value(WorkScheduleValue value) {
  ...
  **/
  ...
  public WorkScheduleValue getValue() {
    return value;
  }


  public void setValue(WorkScheduleValue value) {
  ...
  public WorkSchedule type(TypeEnum type) {
  ...
  **/
  ...
  public WorkSchedule universalId(Object universalId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "work_schedule", value = "")
   ...
   * @return the WorkSchedule instance itself
   */
  public WorkSchedule putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.label, workSchedule.label) &&
        Objects.equals(this.value, workSchedule.value) &&
        Objects.equals(this.type, workSchedule.type) &&
        Objects.equals(this.universalId, workSchedule.universalId)&&
        Objects.equals(this.additionalProperties, workSchedule.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkSchedule
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!WorkSchedule.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("value") != null && !jsonObj.get("value").isJsonNull()) {
        WorkScheduleValue.validateJsonObject(jsonObj.getAsJsonObject("value"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WorkSchedule>() {
           ...
           public WorkSchedule read(JsonReader in) throws IOException {
             ...
             WorkSchedule instance = thisAdapter.fromJsonTree(jsonObj);
