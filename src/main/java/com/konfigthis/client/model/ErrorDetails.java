...
public class ErrorDetails {
  ...
  private List<ErrorMeta> meta = null;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Report not found", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "search", value = "")
  ...
  public ErrorDetails meta(List<ErrorMeta> meta) {
  ...
  public ErrorDetails addMetaItem(ErrorMeta metaItem) {
    if (this.meta == null) {
  ...
  **/
  ...
  public List<ErrorMeta> getMeta() {
    return meta;
  }


  public void setMeta(List<ErrorMeta> meta) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("_meta") != null && !jsonObj.get("_meta").isJsonNull()) {
        JsonArray jsonArraymeta = jsonObj.getAsJsonArray("_meta");
        if (jsonArraymeta != null) {
          // ensure the json data is an array
          if (!jsonObj.get("_meta").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `_meta` to be an array in the JSON string but got `%s`", jsonObj.get("_meta").toString()));
          }

          // validate the optional field `_meta` (array)
          for (int i = 0; i < jsonArraymeta.size(); i++) {
            ErrorMeta.validateJsonObject(jsonArraymeta.get(i).getAsJsonObject());
          };
        }
      }
  }
